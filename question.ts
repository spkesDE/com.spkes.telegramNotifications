...
export default class Question {
  ...
  columns = 2;
    ...
    static async createMessage(q: Question, app: TelegramNotifications, userId: number,
                               opts?: { messageOverride?: string, customId?: string, image?: string, topic?: number }) {
      ...
      let id = q.UUID + '.' + i;
        ...
        {
          caption:
              opts?.messageOverride == undefined ? q.question : opts?.messageOverride,
